...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ImageView_t, stringdata) + ofs \
...
const QMetaObject ImageView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ImageView.data,
      qt_meta_data_ImageView,  qt_static_metacall, 0, 0}
};
