...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_VectorView_t, stringdata) + ofs \
...
const QMetaObject VectorView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_VectorView.data,
      qt_meta_data_VectorView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VectorView.stringdata))
        return static_cast<void*>(const_cast< VectorView*>(this));
